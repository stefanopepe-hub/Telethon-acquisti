...
const distributorBrands = [
  ...
  // === BRAND AGGIUNTIVI DA SITI WEB DISTRIBUTORI (Marzo 2026) ===
  // Bio-Techne sub-brands
  ...
  // Aurogene - brand aggiuntivi rilevanti
  ...
  // Euroclone - brand aggiuntivi
  { distributore: 'Euroclone S.p.A.', brand: 'Bio X Cell', esclusiva: false },
  { distributore: 'Euroclone S.p.A.', brand: 'Celemics', esclusiva: false },
  { distributore: 'Euroclone S.p.A.', brand: 'LI-COR Biosciences', esclusiva: false },
  { distributore: 'Euroclone S.p.A.', brand: 'Nordmark', esclusiva: false },
  { distributore: 'Euroclone S.p.A.', brand: 'S2 Genomics', esclusiva: false },
  { distributore: 'Euroclone S.p.A.', brand: 'Sage Science', esclusiva: false },
  { distributore: 'Euroclone S.p.A.', brand: 'Sophia Genetics', esclusiva: false },
  // Diatech Lab Line - brand aggiuntivi
  { distributore: 'Diatech Lab Line srl', brand: 'NanoString Technologies', esclusiva: false },
  { distributore: 'Diatech Lab Line srl', brand: 'Labnet International', esclusiva: false },
  // Prodotti Gianni - brand aggiuntivi rilevanti
  ...
  // TebuBio - brand aggiuntivi rilevanti
  ...
  // Twin Helix - brand aggiuntivi
  { distributore: 'Twin Helix srl', brand: 'Phase Holographic Imaging', esclusiva: false },
  { distributore: 'Twin Helix srl', brand: 'Fluidic Analytics', esclusiva: false },
];
